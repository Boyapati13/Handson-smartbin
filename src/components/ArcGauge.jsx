...
export default function ArcGauge({ pct, size = 80, stroke = 7 }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" aria-label={`Fill level: ${pct}%`} role="img">
      {/* Track */}
      ...
      <text x={cx} y={cy + 1} textAnchor="middle" dominantBaseline="middle"
        fill={color} fontSize="13" fontWeight="600" fontFamily="IBM Plex Mono, monospace">
        {pct}%
      </text>
    </svg>
  )
